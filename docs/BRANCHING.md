...
```
main              ← Production. Protected. Triggers deploy to gifav.veinpal.com
...
8. Merge triggers deploy to **gifav.veinpal.com**
...
| ----------- | -------- | -------------------------- | ----------- |
| Development | `feat/*` | `localhost:5173`           | No          |
| Preview     | `feat/*` | Vercel preview URL         | Yes         |
| Staging     | develop  | Vercel preview URL         | Yes         |
| Production  | main     | `https://gifav.veinpal.com`| Yes         |
...
| `VERCEL_PROJECT_ID`| Vercel project ID for GetIconFav|
