...
We take security seriously. Although GetIconFav is a 100% client-side application (no server, no data uploads), we still want to ensure the code is safe for users.
...
- Information leakage through generated `.ico` files
